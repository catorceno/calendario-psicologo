...
function fillEventDetailsDialog(parent, event) {
  ...
  const eventDetailsEmailElement = eventDetailsElement.querySelector("[data-event-details-email]");
  const eventDetailsPhoneElement = eventDetailsElement.querySelector("[data-event-details-phone]");
  const eventDetailsCiElement = eventDetailsElement.querySelector("[data-event-details-ci]");
  ...
  eventDetailsEmailElement.textContent = event.email || "";
  eventDetailsPhoneElement.textContent = event.phone || "";
  eventDetailsCiElement.textContent = event.ci || "";
